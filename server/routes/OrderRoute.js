...
import { orderStatusUpdateSchema } from '../schemas/OrderSchema.js'

export const orderRoute = Router()

orderRoute.post("/", authMiddleware, createOrder)
orderRoute.patch("/:id/status", authMiddleware, validateRequest(orderStatusUpdateSchema), updateOrderStatus)
