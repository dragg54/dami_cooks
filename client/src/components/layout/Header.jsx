  ...
  return (
    <div className='h-16 bg-white flex md:px-16 justify-between items-center p-4 w-full border-b shadow-gray-300'>
      ...
      }
      {
       ...
       { getScreenSize().isMobile ? <div></div>:!user.user? <span className="text-sm font-semibold h-full flex items-center">LOGIN</span>: <span className="text-sm font-semibold h-full flex items-center">LOGOUT</span>}
